...
import {
    ...
    HttpsLocationMapper,
    LocationMapper,
    IPAddressLocationMapper,
    LocalhostLocationMapper
...
export default new ContainerModule(bind => {
    ...
    bind(LocationMapper).to(IPAddressLocationMapper).inSingletonScope();
    bind(LocationMapper).to(LocalhostLocationMapper).inSingletonScope();
